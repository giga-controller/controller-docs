...
```
Get me all events that are happening on UTC Sep 22 2024
```
...
```
Update the event titled "Talk to Investors" to "Talk to Users"
```
...
```
Delete the event titled "Talk to Investors"
```
...
When giving instructions, make sure to specify your timezone and the specific date and time as clearly as possible.
