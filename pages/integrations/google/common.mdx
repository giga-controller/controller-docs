...
How to quickly get ALL your Google OAuth2 applications set up.
...
<Image src="/gcp.png" alt="GCP setup" width={800} height={400} />
...
<Image src="/search.png" alt="GCP search" width={800} height={400} />
...
5. In the Authorized domains section, add usecontroller.com.
...
4. Add `https://www.usecontroller.com/api/oauth2/callback` as the Authorized redirect URIs in Google Console.
5. Select CREATE.
...
| :--------------------- | :--------------------------------------------------------------------: |
| Gmail                  |         Send Emails <br/> Get Emails <br/> Mark Emails as read         |
| Google Calendar        | Create Events <br/> Get Events <br/> Update Events <br/> Delete Events |
