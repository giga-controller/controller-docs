...
7. Add https://https://www.usecontroller.com/api/oauth2/callback as the Callback URL.

8. Add https://www.usecontroller.com/ as the Developer URL.
   It should look something like this

<Image src="/x.png" alt="X OAuth setup" width={500} height={200} />
...
You can send a tweet by specifying the content

```
Send a tweet affirming Aaron that he is awesome at talking to users
```
