...
<br/>
<Image src="/linear/oauth2.png" alt="Linear OAuth setup" width={800} height={400} />
...
<br/>
<Image src="/linear/members.png" alt="Linear Members" width={400} height={400} style={{ display: 'block', margin: '0 auto' }} />
